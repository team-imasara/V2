        ...
        public void setUserInfo()//ui更新
        {
            try
            {
                ...
                im.mainWindow.Dispatcher.BeginInvoke(new Action(() =>
                {
                    ...
                    im.mainWindow.UserLevel.Text = "Lv." + userInfo.lv.ToString();
                    ...
                    try
                    {
                        ...
                        im.mainWindow.textitem1.Text = Convert.ToString(item_with_user_info[findKey].number);//人形制造契约:item_with_user_info
                    }
                    ...
                    try
                    {
                        ...
                        im.mainWindow.textitem3.Text = Convert.ToString(item_with_user_info[findKey].number);//快速制造契约: 
                    }
                    ...
                    try
                    {
                        ...
                        im.mainWindow.textitem4.Text = Convert.ToString(item_with_user_info[findKey].number);
                    }
                    ...
                    try
                    {
                        ...
                        im.mainWindow.textitem8.Text = Convert.ToString(item_with_user_info[findKey].number);
                    }
                    catch (Exception) { im.mainWindow.textitem8.Text = "0"; }



                    im.mainWindow.textDevelopSlot.Text = userInfo.max_build_slot.ToString();//建造槽
                    im.mainWindow.textFixSlot.Text = userInfo.max_fix_slot.ToString();
                    im.mainWindow.textUpgradeSlot.Text = userInfo.max_upgrade_slot.ToString();

                    im.mainWindow.textGunNum.Text = String.Format("{0}/{1}", userInfo.gun_collect.Count, userInfo.maxgun);
                    im.mainWindow.textTeamNum.Text = userInfo.maxteam.ToString();
                    im.mainWindow.textUnlockRatio.Text = ((int)((double)userInfo.gun_collect.Count / (double)im.catchdatasummery.gun_info.Count* 100)).ToString() + "%";
